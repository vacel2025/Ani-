...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Manu";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2026-07-31T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntos de conocernos: <b>${days}</b> días<br>` +
